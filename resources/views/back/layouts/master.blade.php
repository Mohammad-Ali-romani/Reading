...
<head>
    ...
    <link rel="stylesheet" href="{{asset('back/css/material-dashboard.css')}}">
    <link rel="stylesheet" href="{{asset('back/css/fonts.google.css')}}">
    <link rel="stylesheet" href="{{asset('back/demo/demo.css')}}">
    <link rel="stylesheet" href="{{asset('back/css/style.css')}}">
    @livewireStyles
</head>
<body>
    <div class="wrapper ">
        <div class="sidebar" data-color="purple" data-background-color="white" data-image="{{asset('back/img/sidebar-1.jpg')}}">
            <div class="logo">
                <a href="{{route('dashboard')}}" class="simple-text logo-normal">Reading</a>
            </div>
            <div class="sidebar-wrapper">
                <ul class="nav">
                    ...
                    <li class="nav-item @yield('post') ">
                        ...
                        <i class="icon-style float-left material-icons far fa-newspaper"></i>
                        <p>Posts</p>
                        </a>
                    </li>
                    <li class="nav-item @yield('comment')">
                        <a class="nav-link" href="{{route('comment.index')}}">
                            <i class="icon-style float-left material-icons fas fa-comments"></i>
                        <p>Comments</p>
                        </a>
                    </li>
                    <li class="nav-item @yield('advertisement')">
                        <a class="nav-link" href="{{route('advertisement.index')}}">
                            <i class="icon-style float-left material-icons fas fa-tv"></i>
                        <p>Advertisement</p>
                        </a>
                    </li>
                    <li class="nav-item @yield('category')">
                        <a class="nav-link" href="{{route('category.index')}}">
                            <i class="icon-style float-left material-icons fas fa-tags"></i>
                        <p>Category</p>
                        </a>
                    </li>
                    <li class="nav-item @yield('settings')">
                        <a class="nav-link" href="{{route('home.index')}}">
                            <i class="icon-style float-left material-icons fas fa-cog"></i>
                        <p>Settings</p>
                        </a>
                    </li>
                </ul>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                                    ...
                                    <a class="dropdown-item"  onclick="$('#logoutform').submit()">Log out</a>
                                </div>
                            </li>
                        </ul>
                    </div>
    ...
    <div class="fixed-plugin">
        <div class="dropdown show-dropdown">
            ...
            <li class="active">
                ...
                <img src="{{asset('back/img/sidebar-1.jpg')}}" alt="">
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                <img src="{{asset('back/img/sidebar-2.jpg')}}" alt="">
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                <img src="{{asset('back/img/sidebar-3.jpg')}}" alt="">
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                <img src="{{asset('back/img/sidebar-4.jpg')}}" alt="">
                </a>
            </li>
    ...
    <script src="{{asset('back/js/material-dashboard.js')}}"></script>
    <script src="{{asset('back/demo/demo.js')}}"></script>
    <script src="{{asset('back/js/googleapis.js')}}"></script>
    <script>
